...
NIP-QUOTE stands alone for simpler use cases but can be composed with lifecycle management, reputation, and escrow NIPs for full-stack service coordination.
